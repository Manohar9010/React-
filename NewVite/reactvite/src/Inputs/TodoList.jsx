        ...
        <div className="d-flex me-5  w-100 ">
          ...
          >
            <div className="d-flex  gap-5">
              <h1 className="text-center px-5">Pending Task</h1>
              
              <Input style={{width:"35px",height:"35px",marginLeft:"92px",marginTop:"10px" }} type="checkbox" onChange={(ell) => multiselctfun(ell)} />
            </div>
