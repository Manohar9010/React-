  ...
  export default function BellalLogin() {
    ...
    const getlogindata = () => {
      if (user.username.length > 0 && user.password.length > 0) {
        ...
        if (matchingUser) {
          localStorage.setItem("userType",JSON.stringify({login: true,usertype:matchingUser.usertype} )); 
        ...
        >
          ...
          <div className="text-dark">
            ...
            <div className="d-flex justify-content-center mb-5 mt-3">
              ...
              <Button  className="w-25 " onClick={logoutfun}
                style={{ background: "black" }}>Log out</Button>
