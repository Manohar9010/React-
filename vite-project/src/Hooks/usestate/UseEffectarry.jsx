...
export default function UseEffectarry() {
    ...
    const namearry=["madhav","vishvak","raju","shiva","raghunandan","chandrashekar","raghav"]
...
useEffect(()=>{
  ...
  <button style={{padding:"15px"}} onClick={namefirst}>Click</button>
   <hr />
  <h1>{scond[secindex]}</h1>

  <button style={{padding:"15px"}} onClick={namesecnd}>Click</button>
