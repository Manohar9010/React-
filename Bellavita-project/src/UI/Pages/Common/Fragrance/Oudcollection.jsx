...
export default function Oudcollection() {

    const[oudodata,setOudodata ]=useState([])
    useEffect(()=>{
      axios({
        method:"get",
        url:"http://localhost:9999/product/getAll",
        params:{color:["oudCollection"]},
      }).then((res)=>{
          setOudodata(res.data.data)
      })
    },[])
  return (
    <div>
        ...
        <div className="mt-56">
            ...
            <h1>Oud Collection Special Perfumes</h1>
            <hr />
            </div>
